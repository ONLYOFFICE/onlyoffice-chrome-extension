# ONLYOFFICE DocSpace Extension for Chrome

The **ONLYOFFICE DocSpace extension for Chrome** is your gateway to seamless document management and editing directly from your browser. With this extension, you can create, upload, and open files effortlessly, all while staying connected to your [DocSpace](https://www.onlyoffice.com/docspace?utm_source=github&utm_medium=cpc&utm_campaign=ChromeExtension).

## Key features

- **🔑 Quick login:** Access your DocSpace account with just a few clicks.
- **📝 Create new files:** Generate documents, spreadsheets, presentations, or PDF forms directly from the extension.
- **🗂️ Upload files:** Easily upload files from your device to your DocSpace for editing and storage.
- **🌐 Open web files:** Detect and open files from web pages in ONLYOFFICE editors.

## Getting started ✔️

### Installing the extension

- Download and install the ONLYOFFICE DocSpace extension from the Chrome Web Store.
- Once installed, the extension will appear in your Chrome extensions list.

### Logging in

- Open the Chrome extensions list and click on **ONLYOFFICE DocSpace**.
...
- Click the **+** button in the lower-right corner of the extension.
...
**🐞 Found a bug?** Please report it by creating an [issue](https://github.com/ONLYOFFICE/onlyoffice-chrome-extension/issues).
