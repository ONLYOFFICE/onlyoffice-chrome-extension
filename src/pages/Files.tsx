...
export const FilesPage: FunctionalComponent<FilesPageProps> = ({
  ...
  return (
    <>
      ...
      {isAuthenticated && (
        <div className="file-list__section file-list__section--recent">
          <Subtitle>{t('files.recent_files')}</Subtitle>
          {hasDisplayFiles ? (
            <>
              <ul className="file-list__list file-list__list--recent">
              ...
              {hasMore && (
              <div ref={sentinelRef} className="file-list__sentinel">
                {loadingMore && (
                <div className="file-list__loading-more">
                  <Spinner size="small" />
